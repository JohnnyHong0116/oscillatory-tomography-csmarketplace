...
def build_case(
    ...
    domain = Domain(
        # The original case uses 50 cells along each axis. This option makes
        # refinement and memory-scaling experiments reproducible.
    ...
    if truth == "checkerboard":
        ...
        # Snap mathematical zero crossings to zero so results do not depend on
        # tiny platform-specific floating-point differences.
